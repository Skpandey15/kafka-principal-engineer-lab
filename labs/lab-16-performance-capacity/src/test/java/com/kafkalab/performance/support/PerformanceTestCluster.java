 ...
 * WP needs no extra infrastructure; benchmarking and capacity math are
 * both properties of the client/broker interaction itself.
 */
public final class PerformanceTestCluster implements AutoCloseable {

    private static final String KAFKA_IMAGE = "apache/kafka:4.3.1";
    private static final String CLUSTER_ID = "K17rrPdV9WW-Ca5Uq3Rj7Gh";
    private static final String KAFKA_ALIAS = "it-kafka";

    private final GenericContainer<?> kafka;
    private final int kafkaHostPort;

    public PerformanceTestCluster(int kafkaHostPort) {
