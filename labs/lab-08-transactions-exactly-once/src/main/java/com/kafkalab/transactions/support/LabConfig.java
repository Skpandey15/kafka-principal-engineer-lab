 ...
 *
 * <p>The default {@code bootstrapServers} points at the WP-07 3-broker
 * cluster ({@code platform/kafka-cluster/}), reused for this WP rather than
 * standing up a new environment -- see the lab README's "Environment"
 * section.
 */
